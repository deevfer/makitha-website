...
<head>
    ...
    <title>Hemos recibido tu información - Makitha</title>
</head>
                    ...
                    <tr>
                        <td style="background:linear-gradient(180deg, #d6edf5 0%, #eef7fb 100%); padding:36px 32px 18px; text-align:center;">
                            ...
                            <p style="margin:12px auto 0; max-width:460px; font-size:15px; line-height:24px; color:#4d4a4b;">
                                Hola <strong>{{ $data['full_name'] }}</strong>, gracias por contactarnos. 
                                Hemos recibido tu solicitud correctamente y pronto uno de nuestros representantes se estará comunicando contigo.
                            </p>
                        </td>
                    </tr>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#fff7fd; border:1px solid #ffd0f6; border-radius:18px;">
                                            <tr>
                                                <td style="padding:20px;">
                                                    <p style="margin:0 0 8px; font-size:12px; text-transform:uppercase; letter-spacing:1px; color:#8a5e84;">Tu solicitud</p>
                                ...
                                <tr>
                                    <td style="padding:18px 20px; text-align:center;">
                                        <p style="margin:0; font-size:13px; line-height:22px; color:#ffffff;">
                                            Gracias por escribirnos. Muy pronto uno de nuestros representantes de <strong>Makitha</strong> se pondrá en contacto contigo.
                                        </p>
                                    </td>
                                </tr>
                            </table>
